...
//Här renderar vi vår SPA.
function App() {
  return (
    <div>
      <Router>
        <nav
          className="navbar navbar-expand-lg navbar-toggleable-sm navbar-light border-bottom box-shadow mb-3"
          style={{ backgroundColor: "#ecf9ff" }}
        >
          <div className="container">
            <Link className="navbar-brand" to="/">
              <img src={Hemnet41} alt="Logo"></img>
            </Link>
            <button
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item">
                  <Link className="nav-link" to="/getobject">
                    <p>Se objekt</p>
                  </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/postobject">
                    <p>Lägg till objekt</p>
                  </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/regofintrest">
                    <p>Intresseanmälningar</p>
                  </Link>
                </li>
                <li className="nav-item">
                  <Login />
        ...
        <Switch>
          ...
          <Route
            exact
            path="/changeobject/:houseObjectId"
            component={ChangeObject}
          />
          <Route
            exact
            path="/deleteobject/:houseObjectId"
