...
// Url Hårdkodas för varje vy, och det enda som skiljer dem åt, är deras endpoints.(OBS REGOFINTRESTS)
const url = "https://hemnetapi.azurewebsites.net/api/RegOfIntrests";
